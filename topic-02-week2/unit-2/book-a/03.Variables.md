...
TIPS Be confident in your use of expanding the variable in your **echo** command using the **${varName}** syntax

Syntax

**varName=$(commands)** for adding in the date and for counting the lines in a file such as **employee.txt**