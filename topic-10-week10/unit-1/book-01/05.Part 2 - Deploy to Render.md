...
![alt text](https://web-dev-2-2025.netlify.app/topic-04-nodejs-render/side-unit/book-render/img/image-5.png)

Click your github username in the dropdown, and then select the repository you created earlier (e.g. `smart-doorbell`).

![alt text](https://web-dev-2-2025.netlify.app/topic-04-nodejs-render/side-unit/book-render/img/image-6.png)

If it is a private repository (preferred) it may not be visible so click on the Configure in GitHub button.
...
![alt text](https://web-dev-2-2025.netlify.app/topic-04-nodejs-render/side-unit/book-render/img/image-8.png)

Select the specific repository to allow it access:

![alt text](https://web-dev-2-2025.netlify.app/topic-04-nodejs-render/side-unit/book-render/img/image-9.png)

Then:

![alt text](https://web-dev-2-2025.netlify.app/topic-04-nodejs-render/side-unit/book-render/img/image-10.png)

Now select the repository in render.

![alt text](https://web-dev-2-2025.netlify.app/topic-04-nodejs-render/side-unit/book-render/img/image-11.png)
