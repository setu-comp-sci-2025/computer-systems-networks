...
+ Download the following Packet Tracer simulation.  
  [Real UDP PT File](./img/archive.zip)
...
+ In the Projects list, double click the **Potentiometer** project to open .
  <img src="./img/image-20260501191027228.png" alt="image-20260501191027228" style="zoom:67%;" />
...
+ Once set up move/drag the RFID card to the card reader and it will send the Card ID to the RPi: 
  ...
  ![image-20251208140318700](./img/image-20251208140318700.png)

+ Stop the program by entering `ctrl+d` in the terminal window
