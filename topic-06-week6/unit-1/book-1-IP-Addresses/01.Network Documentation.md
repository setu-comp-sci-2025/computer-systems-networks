...
| Guest Laptop         | FastEthernet0   | 192.168.10.3    | 255.255.255.0   | ???             |
...
| Office Printer       | FastEthernet0   | 192.168.1.3     | ???             | 192.168.1.1     |
| Office PC            | FastEthernet0   | 192.168.1.2     | ???             | ???             |
| File Server          | FastEthernet0   | ???             | ???             | ???             |



Using the Logical Network View in Packet Tracer and data in the above table, answer the following questions and complete the missing information (indicated by the ???)
