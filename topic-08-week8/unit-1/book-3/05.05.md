...
The wifi  **connection name** is `preconfigured`. Lets modify this to be something more meaningful. Run the following:
...
*(Replace `WIFI_HOME` with your actual connection name and adjust the IP address and gateway based on what you found in the last steps.)*
