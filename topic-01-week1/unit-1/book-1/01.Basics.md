...
3. **Visual Studio Code** is another alternative (**VS Code** is an integrated development environment developed by Microsoft for Windows, Linux, macOS and web browsers)

# Which is best for class?


![Choose ANY distro](./img/pickAnyOne.png)

It's totally up to you based on:
- preference and/or 
- previous experience. 

The final output of a file will still be the same whichever editor you choose!
