...
+ Create a new folder in your home folder called ***week12-example***.
...
+ Leave this process sunning for the next step. 
...
+ Download the following Packet Tracer simulation.  
  ...
  <img src="./img/01.Set Up/image-20241209145010766.png" alt="image-20241209145010766" style="zoom:50%;" />

+ Double click on the Motion Sensor to configure it. Select the Advanced button and open the Programming tab. 

<img src="./img/01.Set Up/image-20241209145214754.png" alt="image-20241209145214754" style="zoom:67%;" />

+ In the Projects list, double click the Motion Sensor project to open
+ Select the ***pi_bridge.py*** script to show the code. Update the IP variable to be the **IP address of the device running the sensor_listener.py script from the last step (i.e. your Rapspberry Pi)** 

<img src="./img/01.Set Up/image-20241209145700499.png" alt="image-20241209145700499" style="zoom:67%;" />
...
![image-20241209151026368](./img/01.Set Up/image-20241209151026368.png) <img src="./img/01.Set Up/image-20241209151235553.png" alt="image-20241209151235553" style="zoom:67%;" />

You now have Sensing in Packet Tracer connected to the RPi. 

### RFID Reader

+ Similar to above, double click on the RFID Reader to configure it. Select the Advanced button and open the Programming tab.
...
+ Once set up move/drag the RFID card to the card reader and it will send the Card ID to the RPi: 
  ...
  <img src="./img/01.Set Up/image-20241209151837476.png" alt="image-20241209151837476" style="zoom:67%;" />

+ To change the card ID, double click on the RFID card and select the Attributes tab to update the CardID atribute: 

<img src="./img/01.Set Up/image-20241209152114444.png" alt="image-20241209152114444" style="zoom:67%;" />

+ Move the card across the RFID reader again - this time, the updated ID will be transm